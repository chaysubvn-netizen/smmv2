...
function layout_change(e) {
    ...
    body.setAttribute("data-pc-theme", e);
    body.setAttribute("data-bs-theme", e); // Sync with Bootstrap 5.3
    
    // Also set sidebar theme to dark for better look in dark mode
    if (e === 'light') {
        body.setAttribute("data-pc-sidebar-theme", "dark");
    } else {
        body.setAttribute("data-pc-sidebar-theme", "light");
    }
