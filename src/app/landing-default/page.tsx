        ...
        <section id="services" className="pt-16 pb-24 border-t border-slate-100 bg-white">
          <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
            <div className="text-center mb-12">
              <h4 className="text-[11px] font-bold text-slate-300 uppercase tracking-[0.2em] mb-8">SERVICES AVAILABLE FOR ALL MAJOR PLATFORMS</h4>
              
              {/* PLATFORMS MINI ROW */}
              <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 text-xl md:text-2xl mb-16">
                <div className="flex items-center gap-2"><InstagramOutlined className="text-slate-600"/><span className="text-[13px] font-extrabold text-slate-800">Instagram</span></div>
                <div className="flex items-center gap-2"><svg className="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.525.02c1.31-.02 2.61-.01 3.91.01.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.95v7.4c-.01 1.96-.81 3.84-2.25 5.2-1.4 1.32-3.3 2.1-5.26 2.06-2.13-.02-4.14-.99-5.5-2.61-1.35-1.62-2-3.78-1.74-5.88.27-2.02 1.34-3.82 2.97-5.02 1.6-1.17 3.63-1.67 5.61-1.39l.13 4.12c-1.18-.3-2.48-.12-3.53.48-1.03.58-1.77 1.65-1.85 2.85-.09 1.25.4 2.5 1.32 3.32 1.05.9 2.55 1.15 3.88.8 1.37-.36 2.55-1.34 3.04-2.67.24-.65.34-1.36.32-2.06V.03l-1.22-.01z" fill="#000000"/><path d="M12.525.02v8.94c-1.44-.05-2.89-.35-4.2-.97v4.12c1.05.9 2.55 1.15 3.88.8v6.92c-1.35-1.62-2-3.78-1.74-5.88l-4.11-2.92c-1.4 1.32-3.3 2.1-5.26 2.06-2.13-.02-4.14-.99-5.5-2.61v4.06c.27-2.02 1.34-3.82 2.97-5.02 1.6-1.17 3.63-1.67 5.61-1.39z" fill="#FE2C55"/><path d="M12.525.02v8.94c.57-.26 1.1-.59 1.62-.95v6.52c.24-.65.34-1.36.32-2.06v-7.14c-1.18-.3-2.48-.12-3.53.48l1.59 4.17z" fill="#25F4EE"/></svg><span className="text-[13px] font-extrabold text-slate-800">TikTok</span></div>
                <div className="flex items-center gap-2"><YoutubeOutlined className="text-[#FF0000]"/><span className="text-[13px] font-extrabold text-slate-600">YouTube</span></div>
                <div className="flex items-center gap-2"><FacebookFilled className="text-[#1877F2]"/><span className="text-[13px] font-extrabold text-slate-600">Facebook</span></div>
                <div className="flex items-center gap-2"><TwitterOutlined className="text-[#1DA1F2]"/><span className="text-[13px] font-extrabold text-slate-600">Twitter / X</span></div>
                <div className="flex items-center gap-2"><img src="https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg" className="w-5 h-5"/><span className="text-[13px] font-extrabold text-slate-600">Telegram</span></div>
                <div className="flex items-center gap-2"><img src="https://upload.wikimedia.org/wikipedia/commons/1/19/Spotify_logo_without_text.svg" className="w-5 h-5"/><span className="text-[13px] font-extrabold text-slate-600">Spotify</span></div>
                <div className="flex items-center gap-2"><svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M15.429 7.625c-1.02-.02-2.247.382-3.085 1.077-.423-1.07-1.427-1.846-2.585-1.921-1.802-.119-3.418 1.144-3.791 2.923-.274 1.309.28 2.68 1.408 3.332.969.56 2.217.433 3.033-.429.624-.658.825-1.57.575-2.433-.141-.486-.475-.905-.92-1.121-.295-.143-.639-.181-.963-.092.302.348.513.782.573 1.25.086.666-.316 1.305-.956 1.442-.647.16-1.341-.165-1.605-.785-.297-.698-.016-1.536.632-1.928.718-.431 1.666-.279 2.196.386.43.539.522 1.258.283 1.884-.339.89-1.259 1.439-2.198 1.488-1.543.08-3.011-.983-3.238-2.502-.27-1.83 1.047-3.6 2.87-3.792 1.25-.132 2.455.539 3.02 1.665.485-1.157 1.637-1.956 2.898-1.968 2.012-.02 3.754 1.547 3.914 3.551.159 1.99-.958 3.86-2.825 4.391-1.404.4-2.915-.098-3.743-1.246l-1.332 3.125c-.244.571-.787.973-1.411 1.002-.68.031-1.314-.378-1.564-.997-.306-.757-.042-1.633.623-2.083l.89-2.09c-.588.583-1.455.772-2.228.471-.856-.334-1.45-1.171-1.498-2.088-.063-1.206.828-2.3 2.023-2.457 1.16-.153 2.257.625 2.52 1.772.062.274.076.56.03.834l.758-1.782c.44-.047.886.009 1.309.213-.678.113-1.218.665-1.348 1.345-.173.901.35 1.834 1.22 2.158 1.066.398 2.302-.125 2.768-1.144.5-1.085.313-2.383-.518-3.25-.794-.827-2.001-1.144-3.136-.788l1.3-3.048c.178-.035.358-.063.539-.08l.191-.015c1.196-.067 2.333.601 2.822 1.677.38.835.347 1.821-.122 2.628-.487.838-1.385 1.365-2.35 1.387-1.135.026-2.18-.707-2.585-1.761 1.037.669 2.459.67 3.491.02 1.353-.853 1.954-2.569 1.4-4.068-.456-1.233-1.758-2.022-3.078-2.022z" /></svg><span className="text-[13px] font-extrabold text-slate-600">Threads</span></div>
                <div className="flex items-center gap-2"><svg className="w-5 h-5 text-[#5865F2]" fill="currentColor" viewBox="0 0 127.14 96.36"><path d="M107.7,8.07A105.15,105.15,0,0,0,81.47,0a72.06,72.06,0,0,0-3.36,6.83A97.68,97.68,0,0,0,49,6.83,72.37,72.37,0,0,0,45.64,0,105.89,105.89,0,0,0,19.39,8.09C2.79,32.65-1.71,56.6.54,80.21h0A105.73,105.73,0,0,0,32.71,96.36,77.7,77.7,0,0,0,39.6,85.25a68.42,68.42,0,0,1-10.85-5.18c.91-.66,1.8-1.34,2.66-2a75.57,75.57,0,0,0,64.32,0c.87.71,1.76,1.39,2.66,2a67.73,67.73,0,0,1-10.87,5.19,77,77,0,0,0,6.89,11.1A105.25,105.25,0,0,0,126.6,80.22h0C129.24,52.84,122.09,29.11,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53s5-12.74,11.43-12.74S54,46,53.89,53,48.84,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.31,60,73.31,53s5-12.74,11.43-12.74S96.2,46,96.12,53,91.08,65.69,84.69,65.69Z"/></svg><span className="text-[13px] font-extrabold text-slate-600">Discord</span></div>
                <div className="flex items-center gap-2"><svg className="w-5 h-5 text-[#0A66C2]" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg><span className="text-[13px] font-extrabold text-slate-600">LinkedIn</span></div>
                <div className="flex items-center gap-2"><svg className="w-5 h-5 text-[#9146FF]" fill="currentColor" viewBox="0 0 24 24"><path d="M2.149 0l-1.612 4.119v16.836h5.731v3.045h3.224l3.045-3.045h4.657l6.269-6.269v-14.686h-21.314zm19.164 13.612l-3.582 3.582h-5.731l-3.045 3.045v-3.045h-4.836v-15.045h17.194v11.463zm-3.582-7.343v6.262h-2.149v-6.262h2.149zm-5.731 0v6.262h-2.149v-6.262h2.149z"/></svg><span className="text-[13px] font-extrabold text-slate-600">Twitch</span></div>
                <div className="flex items-center gap-2"><svg className="w-5 h-5 text-[#FF5500]" fill="currentColor" viewBox="0 0 100 100"><path d="M60 41c0-10.5-8.5-19-19-19-8.4 0-15.6 5.5-18.1 13.1-1.1-.1-2.1-.1-3.2-.1-9.9 0-18 8.1-18 18 0 9.8 7.9 17.8 17.7 18h46.6c8.5 0 15.4-6.9 15.4-15.4s-6.9-15.4-15.4-15.4c-.2 0-.4 0-.6 0.1v-0.1c0-0.1 0-0.1 0-0.1z"/></svg><span className="text-[13px] font-extrabold text-slate-600">SoundCloud</span></div>
              </div>
            </div>
